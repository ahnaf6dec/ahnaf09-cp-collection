...
template <class T>
void dbv(const T& v, string n = "") {
  cerr << (n.empty() ? "" : n + "=") << "[ ";
  for (auto& x : v) cerr << x << " ";
  cerr << "]\n";
}
template <class A, class B>
void dbp(const pair<A, B>& p, string n = "") {
  cerr << (n.empty() ? "" : n + "=") << "(" << p.first << "," << p.second
       << ")\n";
}
template <class T>
void dbvp(const T& v, string n = "") {
  cerr << (n.empty() ? "" : n + "=") << "[ ";
...
template <class T>
void dbv(const T&, string = "") {}
template <class A, class B>
void dbp(const pair<A, B>&, string = "") {}
template <class T>
void dbvp(const T&, string = "") {}
#endif
